...
ChangeLog_head = '-- XPrime Changelog --' #% version
Scrubsv2Log_head = '-- XPrime Current Version - v%s --' % version
DebugLog_head = '--[XPrime - %s - DebugLog]--' % version
DEBUGPREFIX = '[XPrime - %s - DEBUG]' % version

LOGPATH = control.transPath('special://logpath/')
log_file = os.path.join(LOGPATH, 'changelog.log')

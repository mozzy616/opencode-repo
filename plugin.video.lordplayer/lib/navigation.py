...
from lib.player import LordPlayerPlayer
from lib.lordplayer.api import LordPlayer, LordPlayerError, STATUS_SEEDING, STATUS_PAUSED
from lib.utils import sizeof_fmt, ThreadLocal

set_logger()
plugin = routing.Plugin()
api = LordPlayer(settings.get_service_address(), settings.get_port(), settings.ssl_enabled())
